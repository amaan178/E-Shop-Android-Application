                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Text(
                              r"Total Price:",
                              style:  TextStyle(fontSize: 14.0, color: Colors.grey,fontWeight: FontWeight.normal),
                            ),
                            Text(
                              "₹ ", style:  TextStyle(fontSize: 16.0, color: Colors.red,fontWeight: FontWeight.normal),
                            ),
                            Text(
                              (model.price).toString(),
                              style:  TextStyle(fontSize: 15.0, color: Colors.grey,fontWeight: FontWeight.normal),
                            ),
                          ],
                        ),
                      ),
